...
class GenericWebViewClient extends WebViewClient {
    ...
    private TorBrowserActivity mainActivity;

    public GenericWebViewClient(TorBrowserActivity mainActivity) {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        ...
        try {
            ...
            if (proxied) {
                Proxy proxy = new Proxy(Proxy.Type.SOCKS, new InetSocketAddress("127.0.0.1", MainActivity.port));
