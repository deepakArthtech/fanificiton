...
function UserAvatar({height,width,fill}) {
  return (
    <Svg
      ...
      fill={fill}
    >
      <Path d="M417.4 71.6C371.2 25.4 309.8 0 244.5 0S117.8 25.4 71.6 71.6 0 179.2 0 244.5s25.4 126.7 71.6 172.9S179.2 489 244.5 489s126.7-25.4 172.9-71.6S489 309.8 489 244.5s-25.4-126.7-71.6-172.9zM244.5 462C124.6 462 27 364.4 27 244.5S124.6 27 244.5 27 462 124.6 462 244.5 364.4 462 244.5 462z" />
