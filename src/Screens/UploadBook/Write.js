        ...
        return(
            <View
                ...
                <View style={[Styles.fd,styles.bottomSheetFd]}>
                    ...
                    <View style={[Styles.fd,{justifyContent:'flex-start',flex:1,left:25,}]}>
                ...
                <View style={[Styles.fd,styles.bottomSheetFd]}>
                    ...
                    <Slider
                        ...
                        style={{flex:1}}
                        thumbStyle={{backgroundColor:appColors.white,borderColor:appColors.borderColor,borderWidth:1}}
                    />
                </View>
                <View style={[Styles.fd,styles.bottomSheetFd]}>
                    <Text style={[styles.font]}>Mode</Text>
                    <View style={[Styles.fd,{justifyContent:'flex-start',flex:1,left:15}]}>
                        <TouchableOpacity style={styles.modeBtn}
                        onPress={()=>setMode('day')}>
                                <Text style={styles.modeTxt}>Day</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.modeBtn,{backgroundColor:appColors.titleColor,left
                        :20}]}
