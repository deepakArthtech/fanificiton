    ...
    return(
        ...
        <View style={styles.topContainer}>
            ...
            <View style={{flex:1, padding:20, backgroundColor:COLORS.white}}>
                ...
                <Image source={require('../assests/icons/left_arrow.png')} style={{width:20, height:20, marginVertical:10}}/>
                <RoundImage/>
                <Text style={{fontSize:24,marginTop:24,  alignSelf:'center', fontWeight:'600'}}> John Doe</Text>
                <View style={{flexDirection:'row', flex:1}}>
                     ...
                     <View style={{alignItems:'center',flex:1}}>
                         <Text style={{marginTop:10,fontWeight:'bold'}}>346</Text>
                         <View style={{flexDirection:'row'}}>
                             <Image source={require('../assests/icons/c.png')} style={{width:20, height:20}}/>
                         <Text> Coins </Text>
                         </View>
                         
                     </View>
                     <View style={{alignItems:'center',flex:1}}>
                         <Text style={{marginTop:10,fontWeight:'bold'}}>3M</Text>
                         <Text> Views</Text>
                     </View>
                </View>
                ...
                <Text style={{fontSize:20,fontWeight:'600', fontWeight:'500'}}>About</Text>
               ...
               <View onPress={()=>navigation.navigate('ChangeIntrest')} style={{flexDirection:'row', end:0,alignSelf:'flex-end', backgroundColor:'#f0e6e6', borderRadius:20,paddingVertical:8,paddingHorizontal:15}}>

               <Image source={require('../assests/icons/pencil.png')} style={{width:16, height:16,}}></Image>
                <Text onPress={()=>navigation.navigate('ChangeIntrest')} style={{ color:COLORS.chocklate,marginLeft:10}}>CHANGE</Text>
               </View>
               
               </View>
            </View>
            <View style={{flexDirection:'row',alignItems:'center' ,flexWrap:'wrap',marginVertical:20}}>
